...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face ((,class (:foreground ,berrys02 :weight semi-bold))))
   ...
   `(helm-ff-directory ((,class (:foreground ,berrys02))))
   `(helm-ff-dirs ((,class (:foreground ,berrys02))))
   `(helm-ff-dotted-directory ((,class (:foreground ,berrys02))))
   ...
   `(helm-source-header ((,class (:height 1.5 :foreground ,berrys02))))
   ...
   `(org-agenda-structure ((,class (:foreground ,berrys02 :height 1.5 :weight bold))))
